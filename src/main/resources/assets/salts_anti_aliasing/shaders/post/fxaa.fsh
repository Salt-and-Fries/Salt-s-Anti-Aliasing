 ...
 *
 * Enhanced FXAA resolve pass that combines luma, color distance, and depth contrast to smooth high-confidence edges while guarding detailed texture regions.
